...
* File: NFLDraftApplication.java                                                                *
* Summary: Create an NFL drafting systems using Java elements covered in this course.           *
*                                                                                               *
* Create a preset list of players. This list will be created every time the                     *
* applications runs, and will be hard-coded. Databases are not covered in this                  *
* class; however feel free to use a persistent database if you would like.                      *
